...
# Extract the 'Cbi' and 'dnbr_LS71' columns and remove rows with NaN values
df = df.dropna(subset=['Cbi', 'dnbr_LS71'])
Cbi = df['Cbi']
dnbr_plus_LS71 = df['dnbr_LS71']
...
if len(Cbi) < 2:
    ...
    plt.savefig('cubic_regression_plot_dNBR_CBI.png')
